...
namespace Chizl.FileCompare
{
    public class CompareDiff
    {
        ...
        internal CompareDiff(ReadOnlySpan<ByteLevel> byteLevelDiff, int line) : this(byteLevelDiff, line, _defaultEncoding) { }
        internal CompareDiff(ReadOnlySpan<ByteLevel> byteLevelDiff, int line, Encoding enc) : this(DiffType.None, line, enc)
        {
